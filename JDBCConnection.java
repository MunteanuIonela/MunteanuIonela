...
import proiect.pao.CPU;
import proiect.pao.HDD;
import proiect.pao.RAM;
import proiect.pao.Vanzator;
...
public class JDBCConnection {
   ...
   public JDBCConnection() throws SQLException {
       ...
       //Userul folosit pentru system este admin
    ...
    public void addData(Vanzator employee) throws SQLException {
    ...
    public void addData(RAM rams) throws SQLException{
        ...
        pst.setString(1,rams.getProducator());
        pst.setDouble(2, rams.getPret());
        pst.setInt(3,rams.getStoc());;
        pst.setDate(4, Date.valueOf(rams.getDataCumpararii());
    ...
    public void deleteDate(Vanzator employee) throws SQLException{
        OracleDataSource ods = new OracleDataSource();
        ods.setURL("jdbc:oracle:oci:@" + database);
        ods.setUser(user);
        ods.setPassword(password);
    ...
    public void deleteDate(HDD hdd) throws SQLException{
        ...
        pst.setString(1, hdd.getProducator());
        rs = pst.executeQuery();
    ...
    public void deleteDate(RAM ram) throws SQLException{
        ...
        pst.setString(1, ram.getProducator());
        rs = pst.executeQuery();
